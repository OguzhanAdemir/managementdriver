		...
		<div class="row">';
			...
			if ( pwddm_fs()->is__premium_only() ) {
				if ( pwddm_fs()->is_plan( 'premium', true ) ) {
					...
					// Photo.
					$pwddm_order_delivery_image = $order->get_meta( 'lddfw_order_last_delivery_image' );
					if ( '' !== $pwddm_order_delivery_image ) {
						$html .= '<div class="col-12">
								<p>'
									. esc_html( __( 'Photo', 'pwddm' ) ) . '<br>' .
										'<img style="display:block;max-width:100%; margin:0 auto" src="' . esc_attr( $pwddm_order_delivery_image ) . '">' .
								'</p>
							</div>';
					}
				}
